...
Panel Assistant can now own these entities instead of MQTT, keeping their entity IDs and history. MQTT support will be removed before ha-paneld 1.0; [Move a panel from MQTT](/home-assistant/move-from-mqtt/) explains how to move ahead of that.
