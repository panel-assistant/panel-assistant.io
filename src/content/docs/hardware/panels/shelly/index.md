...
| `platform.has_recents`            | `true`                                                        | `true`                                                    | declared by both profiles; the X2i ignores the Recents key, but the route the app uses is untested there                      |
...
- `platform.has_recents`, on every model including the X2i. Both profiles declare `true`; the X2i ignores the Recents key, but the accessibility route the app actually uses has not been tried there.
