...
1. Choose a version on the Panel Assistant page. Only ha-paneld releases that Home Assistant can verify for installation are listed: the latest stable release, plus any recent release candidates, which are marked as test versions.
